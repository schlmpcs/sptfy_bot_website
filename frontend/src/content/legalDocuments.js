      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Фактические реквизиты предпринимателя, ИНН, ОГРНИП и регистрационный адрес заполняются в отдельном конфигурационном файле сайта и используются в футере и на этой странице.',
          ],
        },
      ],
    },
